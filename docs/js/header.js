...
(function() {
  ...
  header.innerHTML =
    '<div class="header-left">' +
      '<a href="https://github.com/terryum/survey-snu-largescale-tactile-hand" target="_blank" rel="noopener" class="header-icon" title="GitHub Repository">' +
      ...
      '</a>' +
    '</div>' +
    '<a href="./" class="header-logo">From Human Hands to Robot Hands</a>' +
