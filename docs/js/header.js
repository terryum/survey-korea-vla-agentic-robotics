...
(function() {
  ...
  header.innerHTML =
    '<div class="header-left">' +
      '<a href="https://github.com/terryum/survey-korea-vla-agentic-robotics" target="_blank" rel="noopener" class="header-icon" title="GitHub Repository">' +
      ...
      '</a>' +
    '</div>' +
    '<a href="./" class="header-logo">From LLM Planners to Agentic Robotics</a>' +
